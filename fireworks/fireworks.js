...
function fireworksInit() {
    ...
    for (let x = 0; x < 100; x++)
    {
        ...
        explosionSpawnerOptions.horizontalSpeed = ((Math.random() * explosionSpawnerOptions.horizontalSpeed) - (explosionSpawnerOptions.horizontalSpeed/2)) * 50;
        explosionSpawnerOptions.verticalSpeed = ((Math.random() * explosionSpawnerOptions.verticalSpeed) - (explosionSpawnerOptions.verticalSpeed/2)) * 50;
        explosionSpawnerOptions.zSpeed = ((Math.random() * explosionSpawnerOptions.zSpeed) - (explosionSpawnerOptions.zSpeed/2)) * 50;
...
function explosionPhysics()
{
    ...
    for (var x = 0; x < explosionSpawnerOptionsArray.length; x++)
    {
        ...
        if ( delta2 > 0 ) {
            ...
            explosionSpawnerOptionsArray[x].gravitySpeed -= 0.2;
            ...
            optionsExplosion.position.y = lastXY[1] + explosionSpawnerOptionsArray[x].gravitySpeed * tock;
